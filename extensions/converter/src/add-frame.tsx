...
import { grabClipboardImageTo, PngpasteNotFoundError } from "./lib/clipboard";
...
export default async function Command() {
  ...
  try {
    ...
    if (e instanceof PngpasteNotFoundError) {
      await showToast({ style: Toast.Style.Failure, title: "pngpaste not found", message: "brew install pngpaste" });
    }
    return;
  }
